 ...
 * the Assignment object will store the data of an assignment including name, type(Hw, Quiz, Exam), date, and course
 * @author Elisa
 */
public class Assignment {
	 ...
	 * @param date: {@link Date} entry of assignment date
